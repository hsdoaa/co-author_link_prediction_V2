...
with open("AMiner_Author.txt", mode="r", encoding="utf-8") as f:  #AMiner_Author_330000
    for line in f:
...
filtered_data['aff'].to_csv(train_path/'co_author_Affiliations_train.csv', index=False) 
filtered_data['R_intersts'].to_csv(train_path/'co_author_R_intersts_train.csv', index=False) 
##############################################################################
...
filtered_data2['aff'].to_csv(test_path/'co_author_Affiliations_test.csv', index=False) 
filtered_data2['R_intersts'].to_csv(test_path/'co_author_R_intersts_test.csv', index=False) 
#######################################################

...
e3<-read.csv(file="C:\\Users\\dsalem\\Documents\\Dr. Hasan\\New_EXP_dblp_lcc\\R_training\\co_authership_training.csv", header=FALSE) #
...
##
ad_matrix_training<-get.adjacency(lcc,sparse=FALSE)
write.csv(ad_matrix_training,file="ad_matrix_training_lcc_330000.csv")
...
write.csv(train_nodes_degree,file="train_nodes_degree.csv")
write.csv(train_nodes_closeness,file="train_nodes_closeness.csv")
write.csv(train_nodes_betweenness,file="train_nodes_betweenness.csv")
...
zaa<-aa2$value
write.csv(zaa,file="aa_train.csv")
...
zcn<-cn2$value
write.csv(zcn,file="cn_train.csv")
...
zkatz<-katz2$value
write.csv(zkatz,file="katz_train.csv")
...
#zj<-j$value
#write.csv(zj,file="jaccard_train.csv")
...
write.csv(zj_igraph ,file="jaccard_train.csv")
...
write.csv(zd_igraph ,file="dice_train.csv")
...
zi<-i$value
write.csv(zi,file="invlogweighted_train.csv")
